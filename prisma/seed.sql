...
-- End-semester matrix form (rows = faculty mapped to class 1, columns = these questions),
-- left unanswered so the matrix UI is exercisable immediately after a reseed.
INSERT INTO feedback_forms (id, created_by_user_id, title, class_id, form_type, rating_scale_id) OVERRIDING SYSTEM VALUE VALUES
  (3, 16, 'End Semester Feedback - 2025-26 Odd Semester', 1, 'end_semester', 1);
...
INSERT INTO feedback_questions (id, form_id, question_text, sequence_no, question_type) OVERRIDING SYSTEM VALUE VALUES
  ...
  (7, 3, 'How would you rate the pace of teaching?',            1, 'rating'),
  (8, 3, 'How would you rate the clarity of concepts explained?', 2, 'rating'),
  (9, 3, 'Any suggestions for improvement?',                     3, 'text');
